# =============================================================================
# Claude Code Tasks — Kubernetes Task Runner Template
# =============================================================================
# Ephemeral task runner for Claude Code on Kubernetes. Receives prompts from
# the Coder Tasks UI and executes them via the Claude Code agent.
#
# Included tools:
#   - Claude Code (via registry module — handles install, AgentAPI, web UI)
...
#   - coder_ai_task        — wires the task to the claude-code module
# =============================================================================
...
data "coder_parameter" "system_prompt" {
  ...
  description  = "Instructions for Claude Code (optional)."
  type         = "string"
  default      = ""
  mutable      = false
...
data "coder_parameter" "setup_script" {
  ...
  description  = "Shell script to run before Claude starts (optional)."
  type         = "string"
  default      = ""
  mutable      = false
...
# -----------------------------------------------------------------------------
# Agent — minimal startup (claude-code module handles its own install)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Task Runner — wires Tasks UI prompt to claude-code module
# -----------------------------------------------------------------------------
...
# claude-code — handles install, AgentAPI, web UI, and task reporting
module "claude-code" {
  count               = data.coder_workspace.me.start_count
